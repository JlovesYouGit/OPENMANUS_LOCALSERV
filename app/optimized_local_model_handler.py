...
class OptimizedLocalModelHandler:
    ...
    async def load_model_on_demand(self, model_name: str):
        ...
        try:
            ...
            model_[REDACTED] if model_name == "tinyllama" else "reasoning"
