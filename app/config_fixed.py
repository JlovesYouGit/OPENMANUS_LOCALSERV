...
class Config:
    ...
    def _initialize_local_models(self):
        ...
        try:
            ...
            if self.is_local_mode:
                from app.local_model_handler import LocalModelHandler
                self.local_model_handler = LocalModelHandler(self._load_config())
    ...
    def _load_initial_config(self):
        ...
        if daytona_config and "daytona_api_key" in daytona_config:
            daytona_settings = DaytonaSettings(**daytona_config)
        else:
            # Provide default values for DaytonaSettings
            daytona_settings = DaytonaSettings(
                daytona_api_key=daytona_config.get("daytona_api_key", "dummy_key_for_testing"),
                daytona_server_url=daytona_config.get("daytona_server_url", "https://app.daytona.io/api"),
